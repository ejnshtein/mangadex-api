import Joi from 'joi'
import { UserAttributes } from '../../types/data-types/user'
import { apiBase, apiResponse } from './base'

export const userAttributesSchema = Joi.object<UserAttributes>({
  username: Joi.string().required(),
  version: Joi.number().required()
})

export const userSchema = apiBase('user', userAttributesSchema.required())
